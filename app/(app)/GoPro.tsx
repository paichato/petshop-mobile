  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Knowing your has never been so easy, only with Petty Pro
        </Text>
        <Image
      ...
      <View style={{ height: hp(50), width: "100%", alignItems: "center" }}>
        ...
        <View style={{ width: "100%", paddingHorizontal: 40, marginTop: 40 }}>
          ...
          >
            <Text style={{ color: colors.text_detail, fontFamily: FONTS.Bold }}>
              Go pro for 599.00 MZN / mês
            </Text>
          </TouchableOpacity>
        </View>
      </View>

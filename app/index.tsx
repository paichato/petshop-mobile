...
export default function Onboarding() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, justifyContent: "space-between", alignItems: "center", backgroundColor:colors.bg_primary, padding:40 }}>
    
    <Text style={{alignSelf:'flex-start', marginTop:20, fontWeight:'800'}}>Doguinho</Text>
    ...
    <View>
    <Text style={{fontSize:34, fontWeight:'800', color:colors.header}}>Encontre seu <Text style={{color:colors.main_sec}}>doguinho</Text>  conosco</Text>
    <Text style={{lineHeight:24, color:colors.text, marginTop:10}}>Encontre o melhor animal e serviços vetrinários próximos de si.</Text>

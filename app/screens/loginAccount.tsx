...
const options=[{id:0, key:'sms', value:'SMS'}, {id:1, key:'whatsapp', value:'Whatsapp'}];
  ...
  return (
    ...
    <CustomText txt='Número de celular' font={AVAILABLE_FONTS.Medium} fontSize={14} color={colors
    .text_detail}  /> 
    ...
    <CustomText txt='🇲🇿 ' font={AVAILABLE_FONTS.Medium} fontSize={14} color={colors.text_detail} />
    <CustomText txt='+258' font={AVAILABLE_FONTS.Medium} fontSize={14} color={colors.text_detail} />
    ...
    <View style={{width:'100%', flexDirection:'row', alignItems:'center', justifyContent:'space-between', marginTop:1}}>
      ...
      <CustomText txt='OU' color={colors.text_detail} font={AVAILABLE_FONTS.SemiBold} />
      <View style={{width:'40%', height:2, backgroundColor:colors.line}}></View>
    </View>

    <View style={{width:'100%'}}>
    <TouchableOpacity style={{borderRadius:10, backgroundColor:colors.bg_primary, padding:10, alignItems:'center', marginTop:20, borderColor:colors.line, borderWidth:2}}>

<CustomText txt='Esquecei senha' font={AVAILABLE_FONTS.Regular} fontSize={14} color={colors.text_dark}  />
</TouchableOpacity>

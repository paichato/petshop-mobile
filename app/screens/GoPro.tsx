...
<Text style={{fontWeight:'400', fontSize:16,color:colors.title_dark, width:'75%'}} >Monthly tips on the best diet for your pet</Text>
  ...
  return (
    <SafeAreaView style={{ flex: 1, justifyContent: "space-between", alignItems: "center", backgroundColor:colors.bg_primary,  }}>
        ...
        <LinearGradient colors={[colors.main, colors.main_50]} style={{height:hp(40), width:wp(100), borderRadius:30, padding:20, paddingTop:80, overflow:'hidden',}} >
      ...
      <Image source={require('../../assets/images/Puppy2.png')} style={{height:300, resizeMode:'contain', overflow:'hidden',  bottom:-150, position:'absolute'}} />
...
<Text style={{fontWeight:'400', fontSize:24,color:colors.white}} >x</Text>
      </TouchableOpacity>
...
<View style={{width:'100%', paddingHorizontal:40, marginTop:40}}>
  <TouchableOpacity style={{width:'100%', height:hp(10), backgroundColor:colors.main_80, alignItems:'center',justifyContent:'center', borderRadius:100,  shadowColor: colors.main,
        shadowOffset: {
          width: 0,
          height: 4,
        },
        ...
        elevation: 9,}}>
    <Text style={{color:colors.white, fontWeight:'800'}}>Go pro for 599.00 MZN / mês</Text>
  </TouchableOpacity>
  <TouchableOpacity style={{marginTop:10,width:'100%', height:hp(10), backgroundColor:colors.bg_primary,borderWidth:2, borderColor:colors.line, alignItems:'center',justifyContent:'center', borderRadius:100}}>
    <Text style={{color:colors.text}}>Go pro for 599.00 MZN / mês</Text>
  </TouchableOpacity>
</View>

  ...
  return (
    <MainContainer>
      <View style={{ width: "100%", marginTop: 20 }}>
        <CustomText
          txt="Código de Verificação"
          font={AVAILABLE_FONTS.Bold}
          fontSize={32}
        />
        <View style={{ flexDirection: "row" }}>
          <CustomText
            txt={`Introduz os 6 dígitos enviados ao teu número de celular ${
              isSms ? "por sms " : "pelo whatsapp"
            }`}
        ...
        <View style={{ marginTop: 20 }}>
          <View style={{ backgroundColor: colors.line, padding: 20 }}>
            <CustomText
              txt="Código de verificação enviado para"
              font={AVAILABLE_FONTS.Medium}
              fontSize={14}
              color={colors.text_detail}
            />
